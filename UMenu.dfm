object fMenu: TfMenu
  ...
  object Label3: TLabel
    ...
    Width = 464
    Height = 30
    Caption = 'Software de Gest'#227'o de Servi'#231'o'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -27
  ...
  object MainMenu1: TMainMenu
    ...
    object Servios1: TMenuItem
      ...
      object GerarNotaServioArquivoCSV1: TMenuItem
        Caption = 'Gerar Nota Servi'#231'o (Arquivo CSV)'
        OnClick = GerarNotaServioArquivoCSV1Click
      end
      ...
      object ImportarClientesCSV1: TMenuItem
        Caption = 'Importar Clientes (CSV)'
        OnClick = ImportarClientesCSV1Click
      end
    end
    ...
    object Administrao1: TMenuItem
      ...
      object ImportarXMLNFSe1: TMenuItem
        Caption = 'Importar XML NFSe'
        OnClick = ImportarXMLNFSe1Click
      end
    end
  ...
  object UserControl1: TUserControl
    ...
    ExtraRight = <
      ...
      item
        FormName = 'frmCadParametros'
        CompName = 'DBEdit20'
        Caption = 'Senha Exclus'#227'o Vale'
        GroupName = 'Par'#226'metros'
      end
      item
        FormName = 'frmCadParametros'
      ...
      item
        FormName = 'frmCadPedido'
        CompName = 'btnCancelar_Pedido'
        Caption = 'Cancelar Pedido'
        GroupName = 'Pedidos'
      end
      item
        FormName = 'frmCadPedido'
        CompName = 'btnCancelar_Item'
  ...
  object ImageList1: TImageList
    ...
    Top = 312
    Bitmap = {
      494C01010C000E00040030003000FFFFFFFFFF10FFFFFFFFFFFFFFFF424D3600
